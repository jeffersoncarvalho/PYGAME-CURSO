# -*- coding: utf-8 -*-
"""
Created on Thu Jul 28 14:36:09 2016
...
pygame.display.set_caption('SNAKE 02')
...
def game_loop():
    ...
    while not finished:
        ...
        if colidiu(x,y,food_x,food_y,30):
            print "COLISAO"
            food_x = random.randrange(30, display_width-30)
            food_y = random.randrange(30, display_height-30)
